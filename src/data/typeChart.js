...
export function getAttackMultiplier(attackType, defenderTypes) {
...
export function getOffensiveMatchups(attackerTypes) {
  return allTypes
    .map((defenderType) => {
...
export function getOffensiveWeakMatchups(attackerTypes) {
  return allTypes
    .map((defenderType) => {
...
export function buildTypeMatchups(types) {
