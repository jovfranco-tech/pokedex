...
describe('PokemonAssistant — submitting questions', () => {
  it('submits the typed question and shows the answer', async () => {
    ...
    expect(askPokemonAssistant).toHaveBeenCalledWith('es legendario?', expect.objectContaining({ name: 'Pikachu' }), [], { pitch: undefined, accent: undefined })
  ...
  it('replays a fallback question when its chip is clicked', async () => {
    ...
    expect(askPokemonAssistant).toHaveBeenCalledWith('¿Este Pokémon es legendario?', null, [], { pitch: undefined, accent: undefined })
  })
